...
function draw() {
  if (mouseIsPressed) {
    ...
    renderCollage();
    blendMode(BLEND);
    rect(selectionRect.x, selectionRect.y, selectionRect.x2, selectionRect.y2);
  }
}
...
function mouseReleased() {
  ...
  selectedFragment = get(
    selectionRect.x,
    selectionRect.y,
    selectionRect.x2 - selectionRect.x,
    selectionRect.y2 - selectionRect.y
  );
  selectionRect = {
    x: 0,
    y: 0,
